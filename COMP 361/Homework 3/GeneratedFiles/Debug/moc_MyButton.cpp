...
QT_MOC_LITERAL(5, 27, 8)
    ...
    "MyButton\0file\0\0string\0name\0loadFile\0"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->file((*reinterpret_cast< string(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyButton::*_t)(string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyButton::file)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyButton::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_MyButton.data,
