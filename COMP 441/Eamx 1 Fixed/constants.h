...
const RECT  COLLISION_BOX_PADDLE = {-30, -40, 30, 40};
const RECT COLLISION_BOX_PUCK = {-40, -40, 40, 40};


// ADD FILE names for IMAGES here
const char PUCK_IMAGE[] = "pictures\\bullet2.png";  // game textures
const char PADDLE_IMAGE[] = "pictures\\target2.png";      // menu texture
