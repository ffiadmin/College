...
Graphics::Graphics()
{
	...
	this->backColor = D3DCOLOR_XRGB(255, 0, 0);
}
...
HRESULT Graphics::showBackbuffer()
{
    ...
    // Clear the backbuffer to lime green <-- Dude, it's likely not going to be "lime green"
	device3d->Clear(0, NULL, D3DCLEAR_TARGET, this->backColor, 0.0f, 0);
