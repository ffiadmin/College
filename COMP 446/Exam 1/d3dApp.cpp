...
D3DApp::D3DApp(HINSTANCE hInstance) :  pRS(0)
{
	mhAppInst   = hInstance;
	mhMainWnd   = 0;
	mAppPaused  = false;
...
void D3DApp::initApp()
{
	...
	rasterizerState.CullMode = D3D10_CULL_NONE; // D3D10_CULL_NONE, D3D10_CULL_FRONT, D3D10_CULL_BACK
	rasterizerState.FillMode = D3D10_FILL_WIREFRAME; // D3D10_FILL_WIREFRAME, D3D10_FILL_SOLID
